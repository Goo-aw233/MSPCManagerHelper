...
class OperationRunner:
    ...
    def run(page_instance, operation_func, operation_name_key, on_completion=None):
        ...
        message = (
            page_instance.app_translator.translate('executing_operation_with_name').format(operation_name=operation_name) + "\n" +
            page_instance.app_translator.translate('please_wait_for_completion') + "\n"
        )
        ...
        def _thread_target():
            try:
                ...
                page_instance.events_textbox.log_to_events(
                    page_instance.app_translator.translate("operation_completed").format(operation_name=operation_name))
