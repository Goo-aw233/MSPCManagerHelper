...
class GetProgramResources:
    ...
    def get_program_icon():
        program_base_dir = Path(__file__).resolve().parents[1]  # ..\assets\icons
    ...
    @staticmethod
    def get_nsudo_path():
        program_base_dir = Path(__file__).resolve().parents[1]  # ..\assets\NSudo
        arch_map = {
    ...
    def get_procdump_path():
        program_base_dir = Path(__file__).resolve().parents[1]  # ..\assets\ProcDump
        arch_map = {
