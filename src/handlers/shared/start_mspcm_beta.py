...
class StartMSPCMBeta:
    ...
    def start_mspcm_beta(logger=None, log_file_path=None, app_translator=None):
        ...
        beta_exe_path = Path(os.getenv("ProgramFiles", r"C:\Program Files")) / "Microsoft PC Manager" / "MSPCManager.exe"
        ...
        def open_with_cmd():
            ...
            subprocess.run(["cmd.exe", "/C", "start", "Microsoft PC Manager Public Beta", f"{registered_class_beta}"],
